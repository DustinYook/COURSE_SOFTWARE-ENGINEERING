		...
		if (phaseIs("off")) // user로부터 들어옴
		{
			for (int i = 0; i < x.getLength(); i++)
			{
				if (messageOnPort(x, "in1", i)) // 1번 포트
				{
					...
					user_temp = job.tmp; // #여기
					System.out.println("user temp : " + user_temp);
